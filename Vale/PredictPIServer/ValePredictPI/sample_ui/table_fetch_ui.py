...
class Ui_MainGui(object):
    def setupUi(self, MainGui):
        ...
        self.tbData = QtWidgets.QWidget()
        self.tbData.setObjectName("tbData")
        self.grpTable = QtWidgets.QGroupBox(self.tbData)
        ...
        self.grpSource = QtWidgets.QGroupBox(self.tbData)
        self.grpSource.setGeometry(QtCore.QRect(0, 10, 511, 91))
        ...
        self.btnForeStart = QtWidgets.QPushButton(self.grpSource)
        self.btnForeStart.setGeometry(QtCore.QRect(420, 20, 85, 51))
        self.btnForeStart.setObjectName("btnForeStart")
        self.tabMain.addTab(self.tbData, "")
    ...
    def retranslateUi(self, MainGui):
        ...
        self.btnForeStart.setText(_translate("MainGui", "Forecast"))
        self.tabMain.setTabText(self.tabMain.indexOf(self.tbData), _translate("MainGui", "Data"))
